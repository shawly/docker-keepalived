...
- `edge`, `edge-a62200ecd52667d03175d8a454818084f27ecafd`, `edge-a62200e` <!-- edge tag -->
...
| `KEEPALIVED_INTERFACE`     | Interface on your host e.g. `eth0` (use `ip -br l` to list all your interfaces). You can also use `auto` to dynamically select an interface based upon the IP and Mask set above.                                                                                                                                                                     | `eth0`    |
