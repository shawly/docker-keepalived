...
- `edge`, `edge-fdd4e95f01e0cbb8d262014b36f9d09c7ac09698`, `edge-fdd4e95` <!-- edge tag -->
...
| `KEEPALIVED_INTERFACE`     | Interface on your host e.g. `eth0` (use `ip -br l` to list all your interfaces)                                                                                                                                                                        | `eth0`    |
